...
> Week 12 · Phase 2 · Systems & Data · time box: **8-10 h**
...
Growth shipped a checkout redesign, declared +3.2% conversion at p=0.04, and rolled it to
100%. Revenue did not move. The analysis is in `basic/their_analysis.md`.

Read it, find the four things wrong with it, then build the tool that would have caught all four
before the rollout — because this will happen again next quarter.

## What "done" looks like

- The tool refuses to report a result when the sample ratio is off.
- Confidence intervals come from a bootstrap, not from an assumption you did not check.
- The written decision includes the guardrail metrics, not just the primary one.
...
Repo plus a one-page "how to read an A/B test" guide — the one you would send to the growth
lead instead of arguing in Slack.
