...
Finance asked what the Week-30 incident system costs per incident handled. Nobody knows. The
best answer anyone gave was "a few hundred a month, probably", and the invoice says otherwise.

Instrument it end to end, attribute cost per step, then run a cost-reduction experiment and
report before-and-after numbers you would defend to a CFO — including what quality you gave up,
because "we cut costs 60%" with no quality number attached is not a result.

## What "done" looks like

- A trace for a full incident run, with token and cost attributed per step.
- A cost-reduction experiment with before/after numbers on both cost and quality.
- Alerts that fire on the thing that actually costs money.
...
Dashboards plus `OPERATIONS.md` plus the architecture poster. The capstone deliverable.
